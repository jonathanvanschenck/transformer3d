...
//   /**
//    * Get the equivalent homogeneous matrix from this quaternion
//    *
//    * If A is the matrix returned by this method, then
//    * the matrix product `[x',y',z',w']^T = A * [x,y,z,w]^T` is will produce
//    * the same inhomogenous vector ([x'/w', y'/w', z'/w'])` as `this.rotate([x,y,z])`
//    *
//    * @return {Matrix} 4x4 matrix equivalent to this quaternion
//    */
//   get homogeneous_matrix() {
//     let mat = this.matrix;
//     for (let i = 0; i < 3; i ++) {
//       mat[i][3] = 0;
//     }
...
// 
//   /**
//    * Get the equivalent homogeneous inverse matrix from this quaternion
//    *
//    * If A is the matrix returned by this method, then
//    * the matrix product `[x',y',z',w']^T = A * [x,y,z,w]^T` is will produce
//    * the same inhomogenous vector ([x'/w', y'/w', z'/w'])` as `this.unrotate([x,y,z])`
//    *
//    * @return {Matrix} 4x4 inverse matrix equivalent to this quaternion
//    */
//   get homogeneous_matrix_inv() {
//     let mat = this.matrix_inv;
//     for (let i = 0; i < 3; i ++) {
//       mat[i][3] = 0;
//     }
//     mat[3] = [0,0,0,1];
...
//   }
   ...
   *
   * @return {UnitQuaternion} The inverse of `this`
   */
  inv () {
    return UnitQuaternion.from_vec( this.qvec_inv );
  }
