...
//   /**
//    * Get the equivalent homogeneous matrix from this shift
//    *
//    * If A is the matrix returned by this method, then
//    * the matrix product `[x',y',z',w']^T = A * [x,y,z,w]^T` is will produce
//    * the same inhomogenous vector ([x'/w', y'/w', z'/w'])` as `this.shift([x,y,z])`
//    *
//    * @return {Matrix} 4x4 matrix equivalent to this shift
//    */
...
// 
//   /**
//    * Get the equivalent homogeneous inverse matrix from this shift
//    *
//    * If A is the matrix returned by this method, then
//    * the matrix product `[x',y',z',w']^T = A * [x,y,z,w]^T` is will produce
//    * the same inhomogenous vector ([x'/w', y'/w', z'/w'])` as `this.unshift([x,y,z])`
//    *
//    * @return {Matrix} 4x4 inverse matrix equivalent to this shift
//    */
